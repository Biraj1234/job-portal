...
class SkillController extends BackendBaseController
{
    protected $panel = 'Skill';  //for section/moudule
    protected $folder = 'backend.skill.'; //for view file
    protected $base_route = 'backend.skill.'; //for route method
    protected $title;
